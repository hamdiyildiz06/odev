                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <input type="hidden" name="finishedAt" id="datetimepicker1" data-plugin="datetimepicker" data-options="{ inline: true, viewMode: 'days', format : 'YYYY-MM-DD HH:mm:ss' }"
                                   value="<?= isset($form_error) ? set_value("finishedAt") : $item->finishedAt; ?>">
                        </div><!-- END column -->
                        <div class="col-md-8">
                            <div class="row">
                                <div class="form-group col-md-12">
                                    <label for="client">Müşteri</label>
                                    <input type="text" class="form-control" id="client" placeholder="İşi Yaptığınız Müşteri" name="client" value="<?php echo isset($form_error) ? set_value("client") : $item->client; ?>">
                                    <?php if (isset($form_error)){ ?>
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" class="form-control" id="place" placeholder="İşi Yaptığınız Yer Mekan Bilgisi" name="place" value="<?= isset($form_error) ? set_value("place") : $item->place; ?>">
                                    <?php if (isset($form_error)){ ?>
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" class="form-control" id="portfolio_url" placeholder="Yapılan İşin İnternet Üzerindeki Bağlantısı" name="portfolio_url" value="<?= isset($form_error) ? set_value("portfolio_url") : $item->portfolio_url; ?>">
                                    <?php if (isset($form_error)){ ?>
