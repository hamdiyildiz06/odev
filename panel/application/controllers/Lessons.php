...
class Lessons extends CI_Controller{
    ...
    public function update($id){
        ...
        if($validate){
            ...
            $update = $this->lesson_model->update(
                array(
                    "id" => $id
                ),
                array(
            ...
            $viewData->item  =  $this->lesson_model->get(
                array(
                    "id" => $id
                )
            );
    ...
    public function delete($id){
        $delete = $this->lesson_model->delete(
            array(
                "id" => $id
            )
        );
