...
class Slides extends CI_Controller{
    ...
    public function save(){
        ...
        if ($this->input->post("allowButton") == "on"){
            ...
            $this->form_validation->set_rules("button_url","Buton URL Başlık","required|trim");
        }
    ...
    public function update($id){
        ...
        if($validate){
            ...
            if ($_FILES["img_url"]["name"] !== ""){
                ...
                $eskiResimiSil = $this->slide_model->get(
                    array(
                        "id" => $id
                    )
                );
                ...
                if ($eskiResimiSil){
                    unlink("uploads/{$this->viewFolder}/1920x650/$eskiResimiSil->img_url");
                }
    ...
    public function delete($id){
        ...
        if($delete){
            ...
            unlink("uploads/{$this->viewFolder}/350x217/$eskiResimiSil->img_url");
            unlink("uploads/{$this->viewFolder}/555x343/$eskiResimiSil->img_url");
    ...
    public function rankSetter(){
        ...
        foreach ($items as $rank => $id ){
            $update = $this->slide_model->update(
                array(
                    "id"      => $id,
                    "rank !=" =>  $rank
                ),
